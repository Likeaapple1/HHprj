...
<!-- Main Sidebar Container -->
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="card card-primary card-outline">
             <div class="card-body">
               ...
               <form action="attstatus" method="post">
              <select name="type" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                  <option value="근무상태" selected disabled="disabled">-- 근 무 --</option>
                 ...
                 <input type="button" onclick="location.href='${path}/attendance/All'" value ="전체조회" class="btn btn-secondary btn-lg ">&nbsp;
                <br>
   ...
   <br><br>
   <iframe src="${path}/attendance/updateContent" width="100%" height="700px%">
   </iframe>
