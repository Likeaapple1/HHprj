               ...
               <form action="list" method="get">
		        <select name="type" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
		            ...
		            <option value="JOB_NAME">직급별</option>
       			 	...
       			 	<input type="search" class="form-control" placeholder="search input" name = "value"><br>
			        <input type="submit" value="검색" class="btn btn-secondary btn-lg">
			        <input type="submit" formaction="${path}/attendance/adminAll" value ="전체조회" class="btn btn-secondary btn-lg">
			    	<br>
			    </form>
