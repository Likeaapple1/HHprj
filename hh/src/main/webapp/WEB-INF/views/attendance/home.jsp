      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="card card-primary card-outline">
             <div class="card-body">
               <h5 class="card-title">출근 / 퇴근 등록</h5>
               <br><br>
				      <c:choose>
				         <c:when   test="${attUser.attDate eq null}">
				            <form action = "" method="post">
				               <span><b>${loginUser.empName}님</b> 출근 등록을 해주세요</span>
				               <input type="submit" formaction="${path}/attendance/home" value = "출&nbsp;근" class="btn btn-primary">
				            </form>
				         </c:when>
				         <c:when   test="${attUser.attDate != null}">
				            <form action = "" method="post">
				               <span><b>${loginUser.empName}님</b> 퇴근 등록을 해주세요</span>
				               <input type = "submit" formaction="${path}/attendance/workout" value ="퇴&nbsp;근" class="btn btn-primary">
				               			<br><span style = "color:gray;">고정 근무 9:00 ~ 18:00</span>
				            </form>
				         </c:when>
				      </c:choose>   
             </div>
           <div id='calendar' style = "height: 1000px; width:1000px; margin: 0 auto;"></div>
           </div>
          </div><!-- /.col -->
          <div class="col-sm-6">
