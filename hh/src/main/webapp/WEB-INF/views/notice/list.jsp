...
<form action="/hh/notice/list/search" method="post">
        <table>
          <tr>
            <td>
              <div class="month left">
                <input class="mon radius" type="date">　<b>~</b>　<input class="mon radius" type="date">　
              <select name="searchType" class="mon radius">
		              <option value="title" label="제목" selected></option>
		              <option value="content" label="내용"></option>
		              <option value="writer" label="작성자"></option>
				</select>
