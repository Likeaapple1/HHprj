...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="appr_form_right">
            ...
            <sub class="appr_form_text4">직원의 근태 및 채용과 관련된 신청양식입니다.</sub>
            <hr>
            <div class="my_often">
                <a href="#">
                    <div class="my_often1">
                ...
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">출장신청서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">출장 신청을 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">외근신청서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">외근을 신청하기 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">채용계획서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">채용계획서는 채용을 위한 사항을 계획하기 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">휴직신청서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">직원의 휴직을 신청하기 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">퇴직신청서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">직원의 퇴직을 신청하기 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">복직신청서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">휴직 후 복직하기 위하여 사용하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
            </div>
