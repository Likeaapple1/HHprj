            ...
            <div class="my_often">
                ...
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">회의록</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">회의 내용을 정리하기 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">업무인수인계서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">퇴사자 발생 시 업무인수인계 사항 보고를 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">경위서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">사건, 사고에 대한 경위를 보고하기 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">시말서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">업무과실 등에 대한 사유를 보고하기 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
            </div>
