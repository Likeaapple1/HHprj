            ...
            <div class="my_often">
                ...
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">명함신청서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">명함신청을 요청하기 위하여 사용하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">경조비신청서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">경조비 지급을 요청하기 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">구매요청서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">회사의 구매를 요청하기 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="my_often1">
                        <div class="my_often1_L">
                            <img src="${path}/resources/css/appr/dist/img/file_img1.png">&nbsp;기본양식
                            <span class="appr_form_text5">퇴직금중간정산신청서</span>
                        </div>
                        <div class="my_often1_R">
                            <span class="appr_form_text4">퇴직금 중간정산을 신청하기 위해 작성하는 양식입니다.</span>
                        </div>
                    </div>
                </a>
            </div>
